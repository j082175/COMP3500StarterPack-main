...
public class Program {
    ...
    public static void main(String[] args) {
        ...
        final int[] altitudes3 = new int[] { 2, 4, 8, 9, 10, 12, 14, 15, 17, 14, 13, 11, 9, 6, 1 }; // 8
        ...
        int maxAltitudeTime4 = MissionControl.findMaxAltitudeTime(altitudes4); // 18

        final int[] altitudes01 = new int[] { 1, 2, 3, 4, 5, 6, 7, 4, 3, 2 };

        ArrayList<Integer> bounds = MissionControl.findAltitudeTimes(altitudes01, 2); // bounds: [ 1, 9 ]
        bounds = MissionControl.findAltitudeTimes(altitudes01, 5); // bounds: [ 4 ]
